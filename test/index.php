...
<body>
    ...
    <div id="reportFormModal" class="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center z-[100]" style="display: none;">
        <div class="modal-content bg-white w-full h-full md:w-auto md:h-auto md:max-w-5xl md:max-h-[90vh] rounded-lg shadow-xl flex flex-col">
            ...
            <!-- START MODIFICATION: Updated sticky footer section -->
            <div id="sticky-footer-container" class="border-t-2 border-gray-300 bg-gray-50 flex-shrink-0">
                        ...
                        <div class="space-y-2">
                            <div>
                                ...
                                <div class="input-wrapper">
                                    <input type="text" id="tuyChonTien" name="tuyChonTien" class="mt-1 w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" placeholder="+50000 or -10000">
                                    <span class="calculation-result"></span>
                                </div>
                            </div>
                            <div>
                                <label for="ghiChuTuyChon" class="text-sm font-medium text-gray-700">Ghi chú tùy chọn:</label>
                                <input type="text" id="ghiChuTuyChon" name="ghiChuTuyChon" class="mt-1 w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" placeholder="Ghi chú cho phần tùy chọn tiền">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="sticky-totals-bar" class="p-2">
                    <div class="max-w-4xl mx-auto flex justify-between items-center text-center relative h-12">
                        <div class="flex-1">
                            <label class="block text-xs font-medium text-gray-500 whitespace-nowrap">Tổng KG</label>
                            <span id="sticky-total-kg" class="text-lg font-bold text-gray-800">0</span>
                        </div>
                        <div class="-translate-y-1/3">
                             <button id="sticky-options-toggle">
                                <span class="text-3xl font-bold text-gray-600">︽</span>
                            </button>
                        </div>
                        <div class="flex-1">
                            <label class="block text-xs font-medium text-gray-500 whitespace-nowrap">Thành Tiền</label>
                            <span id="sticky-total-tien" class="text-lg font-bold text-indigo-600">0</span>
                            <div id="sticky-total-tien-breakdown" class="text-xs text-gray-500 h-4"></div>
                        </div>
                    </div>
                </div>
            </div>
